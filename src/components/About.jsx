...
const About = () => {
  ...
  return (
    <div className="cursor-default  justify-self-center container pt-[10vh] rounded-xl bg-zinc-950 flex justify-center max-sm:flex-col max-sm:mt-[10vh]">
      <div className="box opacity-0 bg-zinc-800 rounded-3xl max-sm:h-80  translate-y-12  w-1/3 max-lg:w-1/3 max-sm:min-w-full">
        <Canvas>
      ...
      <div className="box opacity-0 md:w-1/2  flex flex-col translate-y-12   rounded-3xl  overflow-hidden w-2/3 max-sm:min-w-full pb-5">
        <div className="flex flex-col items-center ">
          ...
          <div className="flex flex-col gap-2  mt-5">
            ...
            <div className="mt-2">My TechStack:</div>
            <div
